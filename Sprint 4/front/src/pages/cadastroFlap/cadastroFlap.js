...
const CadastrarFlap = () => {
    ...
    var handleCadastrarFlap = function (e) {
        ...
        if (!validarCamposVaziosWeightAbove()) {
            Swal.fire({
                icon: 'error',
                title: 'Weight bellow cannot be empty',
        ...
        if (!validarCamposVaziosWeightBellow()) {
            Swal.fire({
                icon: 'error',
                title: 'Weight above cannot be empty',
        ...
        if (!validarCamposNegativos()) {
            Swal.fire({
                ...
                text: 'Weight(bellow), Temp(bellow), Wind(Head Wind) and Slope(Uphil)',
        ...
        if (!validarCamposPositivos()) {
            Swal.fire({
                ...
                text: 'Ref, Weight(above), Temp(above), Wind(Tail Wind), Slope(Downil), Vap and Ref',
